...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(CancelDomainException.class)
    public ResponseEntity<ApiResponse<Void>> handleCancelDomainException(CancelDomainException e) {
        log.error("CancelDomainException: {}", e.getMessage());
