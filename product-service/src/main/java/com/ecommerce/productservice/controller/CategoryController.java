...
public class CategoryController {
    ...
    public ApiResponse<List<CategoryResponse>> getAllCategories() {
        log.info("GET /api/categories - 전체 카테고리 목록 조회");
    ...
    public ApiResponse<List<CategoryResponse>> getRootCategories() {
        log.info("GET /api/categories/root - 루트 카테고리 목록 조회 (계층구조)");
    ...
    public ApiResponse<List<CategoryResponse>> getChildCategories(@PathVariable Long parentId) {
        log.info("GET /api/categories/{}/children - 하위 카테고리 조회", parentId);
    ...
    public ApiResponse<CategoryResponse> updateCategory(
        ...
        log.info("PUT /api/categories/{} - 카테고리 수정", categoryId);
