...
public class AdminCouponController {
    ...
    public ResponseEntity<ApiResponse<CouponResponse>> createCoupon(
        ...
        return ResponseEntity.ok(ApiResponse.success(response, "쿠폰이 성공적으로 생성되었습니다."));
    }

    @Operation(summary = "쿠폰 대량 지급 (특정 사용자 그룹)")
    ...
    public ResponseEntity<ApiResponse<BulkGrantCouponResponse>> bulkGrantCoupon(
        ...
        return ResponseEntity.ok(ApiResponse.success(response, "쿠폰 대량 지급 요청이 성공적으로 처리되었습니다."));
    }
    ...
    public ResponseEntity<ApiResponse<CouponResponse>> updateCoupon(
        ...
        return ResponseEntity.ok(ApiResponse.success(response, "쿠폰이 성공적으로 수정되었습니다."));
    }

    @Operation(summary = "쿠폰 삭제 (비활성화 처리)")
    @DeleteMapping("/{couponId}")
    public ResponseEntity<ApiResponse<Void>> deleteCoupon(@PathVariable Long couponId) {
        couponService.deleteCoupon(couponId);
        return ResponseEntity.ok(ApiResponse.success(null, "쿠폰이 성공적으로 삭제되었습니다."));
    }
}
